...
FORBIDDEN_LEGACY_PREFIXES = (
    ...
    "semantic_context_server.usecases.narrative_event",
    "semantic_context_server.usecases.run_benchmark",
    "semantic_context_server.application.usecases.narrative_event_usecase",
    "semantic_context_server.application.usecases.run_benchmark_usecase",
